...
def process_data():
    ...
    for i in range(0,num_seq-1):
        ...
        list_of_bacharrays.append(element.astype(theano.config.floatX))
    return list_of_bacharrays
...
def build_rnnrbm(n_visible, n_hidden, n_hidden_recurrent):
    ...
    (v_t, u_t), updates_generate = theano.scan(
        ...
        outputs_info=[None, u0], non_sequences=params, n_steps=5*8000)
...
class RnnRbm:
    ...
    def generate(self, filename, show=True):
        ...
        list_of_samples =  np.expand_dims(list_of_samples,1)
        list_of_samples = norm_audio(list_of_samples)

        print ("starting write")
        scipy.io.wavfile.write("test.wav",8000,list_of_samples)
        print ("end write")
